...
proc create_root_design { parentCell } {
  ...
  set FCLK_CLK_150 [ create_bd_port -dir O -type clk FCLK_CLK_150 ]
  set_property -dict [ list \
  ...
  set clk_out_180 [ create_bd_port -dir O -type clk clk_out_180 ]
  set_property -dict [ list \
  ...
  set lms_pcore_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:lms_pcore:1.0 lms_pcore_0 ]
 ...
 ] [get_bd_intf_pins /lms_pcore_0/AXI_Lite]
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /nco_0/S_AXI_AXI4LITES]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {10.000000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /zed_audio_ctrl_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins nco_0/S_AXI_AXI4LITES] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins lms_pcore_0/AXI_Lite] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins zed_audio_ctrl_0/S_AXI]

  # Create port connections
  connect_bd_net -net SDATA_I_0_1 [get_bd_ports SDATA_I] [get_bd_pins zed_audio_ctrl_0/SDATA_I]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk_out_180] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net led_controller_0_LEDs_out [get_bd_ports LEDs_out] [get_bd_pins led_controller_0/LEDs_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins led_controller_0/s00_axi_aclk] [get_bd_pins lms_pcore_0/AXI_Lite_ACLK] [get_bd_pins lms_pcore_0/IPCORE_CLK] [get_bd_pins nco_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins zed_audio_ctrl_0/S_AXI_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports FCLK_CLK_150] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins led_controller_0/s00_axi_aresetn] [get_bd_pins lms_pcore_0/AXI_Lite_ARESETN] [get_bd_pins lms_pcore_0/IPCORE_RESETN] [get_bd_pins nco_0/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_controller_0/S00_AXI/S00_AXI_reg] SEG_led_controller_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs lms_pcore_0/AXI_Lite/reg0] SEG_lms_pcore_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs nco_0/S_AXI_AXI4LITES/Reg] SEG_nco_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs zed_audio_ctrl_0/S_AXI/reg0] SEG_zed_audio_ctrl_0_reg0
